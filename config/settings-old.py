"""
AGGRESSIVE MODE — Target 20%/month
Risk สูง | Compounding ON | Confidence Scaling ON
"""
...
# QUALITY FILTER
# ============================================================
MIN_QUALITY_SCORE = 40    # Aggressive: ผ่อนปรน (default 55)
...
PARTIAL_CLOSE_1_ATR = 0.6
PARTIAL_CLOSE_1_PCT = 0.40
PARTIAL_CLOSE_2_ATR = 1.2
PARTIAL_CLOSE_2_PCT = 0.40

# ============================================================
# RECOVERY
# ============================================================
RECOVERY_DRAWDOWN_TRIGGER = 8.0
RECOVERY_RISK_PERCENT = 1.0
