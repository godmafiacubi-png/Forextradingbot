...
from risk_management.regime_exit import REGIME_EXIT_POLICIES
...
# ============================================================
# REGIME-AWARE EXIT POLICY
# ============================================================
# Adjust SL/TP, break-even, partial close, trailing, and risk by market regime.
# Values are ATR multipliers; risk_mult scales the symbol risk before sizing.
...
MAX_SPREAD_POINTS_BTCUSDM = _env_int('MAX_SPREAD_POINTS_BTCUSDM', 1200)
BTC_MAX_ENTRY_SPREAD_POINTS = _env_int('BTC_MAX_ENTRY_SPREAD_POINTS', MAX_SPREAD_POINTS_BTCUSDM)
MAX_SLIPPAGE_POINTS = {
    'EURUSDm': 30,
    'GBPUSDm': 30,
    'USDJPYm': 30,
    'BTCUSDm': _env_int('MAX_SLIPPAGE_POINTS_BTCUSDM', 600),
...
def get_symbol_config(symbol):
    defaults = {
        ...
        'live_ml_buy_threshold': ML_THRESHOLD_BUY,
        'live_ml_sell_threshold': ML_THRESHOLD_SELL,
        ...
        'max_lot': 5.0,
        'regime_exit_policies': REGIME_EXIT_POLICIES,
    }
